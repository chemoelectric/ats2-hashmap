...
local
  ...
  hashmap$hash_function<hash_t><key_t> (key, hash) =
    (* Keep only seven bits of the key. *)
    hash := key land (cast8 0x7FU)
...
test_fill_1 () : void =
  {
    ...
    val _ =
      assertloc
        (compare_structure
          (map, "tests/2021.10.29.13.44.21.structure",
           "tests/2021.10.29.13.44.21.structure.reference"))
...
test_replace_1 () : void =
  {
    ...
    val _ =
      assertloc
        (compare_structure
          (map, "tests/2021.10.29.13.58.50.structure",
           "tests/2021.10.29.13.58.50.structure.reference"))
