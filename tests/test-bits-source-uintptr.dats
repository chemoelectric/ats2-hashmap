...
test_num_bits_eq_5 () : void =
  {
    ...
    val _ = assertloc ((source (hash, 15U)).1 = BITS_SOURCE_EXHAUSTED)
    val _ = assertloc ((source (hash, 100U)).1 = BITS_SOURCE_EXHAUSTED)
