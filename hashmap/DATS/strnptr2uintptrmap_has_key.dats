...
implement
strnptr2uintptrmap_has_key_strnptr (map, key) =
  strnptrmap_has_key<uintptr> (map, key)

implement
strnptr2uintptrmap_has_key_strptr (map, key) =
  let
    val s = $UNSAFE.castvwtp1{Strnptr1} key
    prval _ = lemma_strnptr_param s
    val result = strnptr2uintptrmap_has_key_strnptr (map, s)
...
implement
strnptr2uintptrmap_has_key_string (map, key) =
